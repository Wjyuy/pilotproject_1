		...
		<table border="1">
			...
			<tr>
			    ...
			    <td>
			        ...
			        <label><input type="radio" name="category_id" value="2"> 반짝세일</label><br>
			        <label><input type="radio" name="category_id" value="3"> 식품</label><br>
			        <label><input type="radio" name="category_id" value="4"> 가구</label><br>
			        <label><input type="radio" name="category_id" value="5"> 도서</label><br>
			        <label><input type="radio" name="category_id" value="6"> 스포츠/레저</label><br>
			        <label><input type="radio" name="category_id" value="7"> 출산/유아용품</label><br>
			        <label><input type="radio" name="category_id" value="8"> 반려동물용품</label><br>
			        <label><input type="radio" name="category_id" value="9"> 뷰티</label>
				</td>
			</tr>
			<tr>
				<td>상품명</td>
