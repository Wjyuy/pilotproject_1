...
<!-- 			        <label><input type="radio" name="category_id" value="1" checked> 반짝세일</label><br> -->
			...
			<tr>
				<td>상태</td>
				<td>
					<label><input type="radio" name="status" value="판매중" checked> 판매중</label><br>
					<label><input type="radio" name="status" value="품절"> 품절</label><br>
					<label><input type="radio" name="status" value="숨김"> 숨김</label>
				</td>
			</tr>
			<tr>
			    <td>
