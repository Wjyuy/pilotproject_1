		...
		<div class="row">
			...
			<div border="1" align="center">
				<form method="post" action=../login_yn>
					<tr height="30">
						<label for="inputPassword5" class="form-label">사용자ID
							(email)</label>
						<input type="text" name="email" id="inputPassword5"
							class="form-control" aria-describedby="passwordHelpBlock">
					</tr>
					<tr height="30">
						<label for="inputPassword5" class="form-label">Password</label>
						<input type="password" style="margin-bottom: 20px" name="password"
					...
					<tr height="30">
						<td colspan="2" align="center"><input type="submit"
							...
							<button class="btn btn-primary"
								onclick="location.href='../logout'">로그아웃</button> <br> <br>
							<a href="find_id" type="submit">ID찾기</a> <a href="find_pw"
							type="submit">비밀번호찾기</a> <a href="customer_register">회원가입</a></td>
					</tr>
				</form>
			</div>
			<div class="col"></div>
